# 난독 아동의 소리 내어 읽기 개선을 위한, 음성 인식 기반 읽기 오류 패턴 분석과 맞춤형 동화책 생성을 활용한 학습 서비스


## 📌 프로젝트 개요  
이 프로젝트는 난독증 등 읽기 학습에 어려움을 겪는 아동을 대상으로, 음성 인식 기반 읽기 오류 분석과 AI 적응형 동화책 생성을 결합한 맞춤형 읽기 학습 서비스입니다. 아동의 낭독 데이터를 분석하여 읽기 오류와 학습 진전도를 파악하고, 이를 바탕으로 개인의 읽기 수준에 맞는 학습 콘텐츠를 제공합니다. </br>
아동이 관심사 키워드를 말하면 AI가 해당 내용을 기반으로 동화 텍스트와 삽화를 실시간 생성합니다. </br>
낭독 과정에서는 아이의 발음 오류, 읽기 속도, 자주 틀리는 단어 등을 분석하여 개인별 난이도에 맞는 텍스트로 조정하고, 맞춤형 피드백을 제공합니다. </br>
읽기 능력 향상을 위한 개인별 학습 경로를 제시함으로써, 아동이 자신의 수준에 맞춘 읽기 훈련을 지속적으로 수행하고 학습에 대한 흥미를 유지할 수 있도록 하는 것을 목표로 합니다. </br>
...
- **적응형 난이도 조절**  
  - 아동의 읽기 데이터(속도, 오류 빈도 등)에 따라 어휘 수준 및 문장 구조를 자동 조절  
